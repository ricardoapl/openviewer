    ...
    <div>
        ...
        >
            ...
            <p class="mt-5 mb-5">
              ...
              <br />
              Please wait while we make things ready for you!
            </p>
        </div>
        <div
          class="container text-center mt-5"
        ...
        >
          ...
          <svg class="bi bi-exclamation-circle text-warning mt-4" width="10em" height="10em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="mt-5 mb-5">
              ...
              <br/>
              It seems an error occurred while logging in or switching to a different project!
            </p>
            <button
              class="btn btn-warning"
              type="button"
              v-on:click="goNextLocation"
            >Go back...
            </button>
        </div>
    </div>
